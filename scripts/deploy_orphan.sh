...
COMMIT_SUBJECT="$(docker compose exec --no-TTY server python -c "from src.pipeline_feed import build_commit_message; import pathlib; print(build_commit_message(pathlib.Path('${ATOM_PATH}')))")"
