...
export ARXIV_CONTINUE_ON_API_ERROR="${ARXIV_CONTINUE_ON_API_ERROR:-false}"
export ARXIV_MAX_BACKFILL_DAYS="${ARXIV_MAX_BACKFILL_DAYS:-8}"
export ARXIV_MAX_RESULTS="${ARXIV_MAX_RESULTS:-50}"
export GITHUB_REPOSITORY="${GITHUB_REPOSITORY:?GITHUB_REPOSITORY must be set}"
export PIPELINE_TODAY="${PIPELINE_TODAY:-}"
export RETRY_BACKOFF_BASE_SECONDS="${RETRY_BACKOFF_BASE_SECONDS:-60}"

echo "ARXIV_API_BASE_URL=${ARXIV_API_BASE_URL}"
echo "ARXIV_CATEGORY_ID=${ARXIV_CATEGORY_ID}"
echo "ARXIV_CATEGORY_STRICT=${ARXIV_CATEGORY_STRICT}"
echo "ARXIV_CONTINUE_ON_API_ERROR=${ARXIV_CONTINUE_ON_API_ERROR}"
echo "ARXIV_MAX_BACKFILL_DAYS=${ARXIV_MAX_BACKFILL_DAYS}"
echo "ARXIV_MAX_RESULTS=${ARXIV_MAX_RESULTS}"
echo "GITHUB_REPOSITORY=${GITHUB_REPOSITORY}"
echo "PIPELINE_TODAY=${PIPELINE_TODAY}"
echo "RETRY_BACKOFF_BASE_SECONDS=${RETRY_BACKOFF_BASE_SECONDS}"
...
docker compose exec \
    ...
    --env ARXIV_CONTINUE_ON_API_ERROR="${ARXIV_CONTINUE_ON_API_ERROR}" \
    --env ARXIV_MAX_BACKFILL_DAYS="${ARXIV_MAX_BACKFILL_DAYS}" \
