...
Feature: FR-007 GitHub Pages serving of the docs directory
  ...
  #
  # FR-007 specifies:
  #   "GitHub Pages is configured to serve the docs/ directory from the
  #    gh-pages orphan branch; the feed URL for account {user} with repository
  #    named {repo} is https://{user}.github.io/{repo}/arxiv/{category}/atom.xml".
  #
  ...
  # scripts/deploy_orphan.sh force-pushes docs/ to the gh-pages orphan branch;
  # this verification is performed manually by the maintainer.
