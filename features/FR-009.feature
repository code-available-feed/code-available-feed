...
Feature: FR-009 Feed self-URL construction
  ...
  Scenario Outline: Feed URL is constructed from GITHUB_REPOSITORY and the lowercased category id
    ...
    Examples:
      ...
      | marcindulak/code-available-feed     | cs.AI    | https://marcindulak.github.io/code-available-feed/arxiv/cs.ai/atom.xml  |
      | marcindulak/code-available-feed     | cs.ai    | https://marcindulak.github.io/code-available-feed/arxiv/cs.ai/atom.xml  |
  ...
  Scenario: Feed self-URL appears as both <feed><id> and <feed><link rel="self" href="..."/>
    ...
    Then the feed-level id element value is "https://marcindulak.github.io/code-available-feed/arxiv/cs.ai/atom.xml"
    And the feed-level link element with rel "self" has href "https://marcindulak.github.io/code-available-feed/arxiv/cs.ai/atom.xml"
